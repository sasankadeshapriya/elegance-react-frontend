...
class Cart extends Component {
     ...
     <Row>
          ...
          <Button onClick={()=>this.removeItem(ProductList.id)} className="btn mt-2 mx-1 btn-lg site-btn"  style={{ width: '15%' }}><i className="fa fa-trash-alt"></i> </Button>

          <Button onClick={()=>this.ItemPlus(ProductList.id,ProductList.quantity,ProductList.unit_price)} className="btn mt-2 mx-1 btn-lg site-btn" style={{ width: '15%' }}><i className="fa fa-plus"></i> </Button>

          <Button onClick={()=>this.ItemMinus(ProductList.id,ProductList.quantity,ProductList.unit_price)} className="btn mt-2 mx-1 btn-lg site-btn" style={{ width: '15%' }}><i className="fa fa-minus"></i> </Button>
...
<div className="col-md-12 p-1 col-lg-12 col-sm-12 col-12">
     ...
     <option value="Dhaka">Kalutara</option>
     <option value="Dhaka">Kurunagala </option>
     <option value="Dhaka">Matara </option>
     <option value="Dhaka">Colombo </option>
     <option value="Dhaka">Jaffna </option>
     <option value="Dhaka">Kandy  </option>
     </select>
</div>
<div className="col-md-12 p-1 col-lg-12 col-sm-12 col-12">
...
<div className="col-md-12 p-1 col-lg-12 col-sm-12 col-12">
     <button onClick={this.confirmOnClick}  className="btn  site-btn" style={{ width: '30%' }}> {this.state.confirmBtn} </button>
</div>
</div>
                    </div>
               </div>
