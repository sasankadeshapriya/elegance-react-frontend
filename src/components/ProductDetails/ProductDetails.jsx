...
<Col className="shadow-sm bg-white pb-3 mt-4" md={12} lg={12} sm={12} xs={12}>
     <Row>
          ...
          <center><InnerImageZoom className="detailimage"  zoomScale={1.8} zoomType={"hover"} src={this.state.previewImg} zoomSrc={this.state.previewImg} /></center>
         

          <center>
               <Container className="my-3" style={{width: '80%' }}>
               <Row>
                    <Col className="p-0 m-0"  md={3} lg={3} sm={3} xs={3} style={{ width: '25%' }}>
                         <center><img onClick={this.imgOnClick} className="w-75 smallimage product-sm-img" src={image_one} /></center>
                    </Col>
                    <Col className="p-0 m-0" md={3} lg={3} sm={3} xs={3} style={{ width: '25%' }}>
                         <center><img onClick={this.imgOnClick} className="w-75 smallimage product-sm-img" src={image_two} /></center>
                    </Col>
                    <Col className="p-0 m-0" md={3} lg={3} sm={3} xs={3} style={{ width: '25%' }}>
                         <center><img onClick={this.imgOnClick} className="w-75 smallimage product-sm-img" src={image_three} /></center>
                    </Col>
                    <Col className="p-0 m-0" md={3} lg={3} sm={3} xs={3} style={{ width: '25%' }}> 
                         <center><img onClick={this.imgOnClick} className="w-75 smallimage product-sm-img" src={image_four} /></center>
                    </Col>
               </Row>
          </Container>
          </center>
          ...
          <button onClick={this.addToCart} className="btn site-btn" style={{ width: '20%', margin : '0.5%' }}> <i className="fa fa-shopping-cart"></i>  {this.state.addToCart} </button>

          <button onClick={this.orderNow} className="btn btn-outline-primary" class="border border-secondary" style={{ width: '20%', background: '#FCE300', color: 'black', border: '1px solid black' , margin : '0.5%' }}> <i className="fa fa-car"></i> {this.state.OrderNow} </button>
               
               <button onClick={this.addToFav} className="btn btn-primary" class="border border-secondary" style={{ width: '20%', background: '#FCE300', color: 'black', border: '1px solid black' , margin : '0.5%' }}> <i className="fa fa-heart"></i> {this.state.addToFav} </button>
          </div>
          </Col>
     </Row>
